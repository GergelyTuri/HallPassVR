...
Path = ["images/combinations/combination1.jpg",
        "images/combinations/combination2.jpg",
        "images/combinations/combination3.jpg"]
...
trash = open("tmp/trash.txt", "w")
# history             = open("tmp/history.txt","a")
output_pattern2path = open("tmp/Pattern2Path.txt", "w")
...
def default():
    ...
    pic_comb1 = "images/combinations/combination1.jpg"
    pic_comb2 = "images/combinations/combination2.jpg"
    pic_comb3 = "images/combinations/combination3.jpg"
    pic_path = "images/paths/path.jpg"
    history_comb_path = 'images/history_combs/'
    history_path_folder = 'images/history_paths/'
...
def history_comb_read():
    ...
    string_dir = 'images/history_combs/'
    extensions = [".jpg"]
    max = 0
    new = 0
...
def delete_hi(deletestring):
    ...
    readfile = open("data/historyCombCount.txt", "r")
    count = 1
    while True:
    ...
    readfile = open("data/historyCombCount.txt", "w")
...
def History_list(comb, count, InforArray):
    ...
    # print(linecache.getline('data/historyCombCount.txt',1))
...
def HistoryPath(sentence):
    ...
    if result_name == '' or result_length_digit == '':
        ...
        historypathfile = open("tmp/historyPath.txt", "a")
...
def image_process():
    ...
    string_dir = 'images/thumbnails/'
    corridor_pattern_dir = 'images/patterns/'
...
img_resize_canvas("images/logos/default.jpg", (65, 40), canvas)

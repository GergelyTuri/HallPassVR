# --- GUI Interface 5/25/2021 ---
#Hongtao Cai - Columbia University 
#1) Add listbox/label/canvas for history combination 
#2) generate ouput file for history combination 
...
def History_list(comb, count, InforArray):
    ...
    history_pic   = history_comb_path + "HistoryComb " + str(History_count) + '.jpg'

    historyCombCount = open("historyCombCount.txt", "a+")
    CombInfo = pattern_count + "      " + str(InforArray)

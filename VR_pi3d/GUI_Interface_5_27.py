# --- GUI Interface 5/27/2021 ---
#Hongtao Cai - Columbia University 
#1) Finish Delete/Delete All/check function
...
def history_comb_read():
    ...
    #print(HistoryCombCount)
    #print(HistoryCombName)
...
def buttonHandler(self):
    ...
    canvas.grid(row = 5, column = 1, columnspan = 1, sticky = W)
...
# --- TODO ---
#1) Need to add Delete/delteAll function deleteAll need a pop up window 
#2) make function can detect same combination
#3) Easter Egg!
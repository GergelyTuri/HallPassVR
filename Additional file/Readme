...
4) Arduno-encoder.ino     : Rotary Encoder Code Used for Arduino Uno (Without library). 
5) ESP32_encoder.ino      : Rotary Encoder Code Used for ESP32 (Only include GPIO Serial Communication).
6) Esp32RotaryEncoder.ino : Another ESP32 Rotary Encoder example
